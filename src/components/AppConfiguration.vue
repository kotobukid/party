...
import {type EVENT_FORMAT, type EVENT_TYPE} from "../const.ts";
...
const format_changed = (format: EVENT_FORMAT) => {
...
<template lang="pug">
  .configuration
    ...
    .formats
      ...
      a(href="#" :class="props.format == 4 ? 'active' : ''" title="白窓の部屋(ガチ・楽しく)" @click.prevent="format_changed(4)")
